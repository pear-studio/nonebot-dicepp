...
class TestDMAgent:
    ...
    def base_context(self):
        return {'character_name': '测试角色', 'character_description': '一个冒险者', 'world': '奇幻世界', 'scenario': '', 'state_text': '体力50/心情50/健康50', 'slot_type': 'system', 'chain_depth': 0, 'diary_context': '', 'events_context': '', 'intention_text': '', 'now_str': '12:00', 'date_str': '2026年01月01日'}
    ...
    async def test_dm_run_parses_valid_json(self, dm_agent, base_context):
        ...
        valid_args = {'content': '测试角色在森林里发现了一株发光的草药。', 'context_summary': '在森林发现发光草药', 'duration_minutes': 15, 'energy_delta': -5, 'mood_delta': 5, 'health_delta': 0}
