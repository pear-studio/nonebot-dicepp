...
使用方法:
    uv run python tests/system/process/module/bot_integration_runner.py              # 自动测试
    uv run python tests/system/process/module/bot_integration_runner.py -i           # 交互模式
    uv run python tests/system/process/module/bot_integration_runner.py --port 8080  # 指定端口
