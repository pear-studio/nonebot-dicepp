...
class AbilityInfo(JsonObject):
    ...
    def __init__(self):
        ...
        self.ability: List[int] = [0] * ability_num
        self.check_prof: List[int] = [0] * check_item_num
        self.check_ext: List[str] = [""] * ext_item_num
        self.check_adv: List[int] = [0] * ext_item_num
    ...
    def perform_check(self, check_name: str, advantage: int, mod_str: str) -> Tuple[str, str, int]:
        ...
        is_skill: bool = check_name in skill_list
        is_saving: bool = check_name in saving_list
        is_attack: bool = check_name in attack_list
