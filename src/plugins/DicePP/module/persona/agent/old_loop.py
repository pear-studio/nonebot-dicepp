"""旧 AgentLoop — 兼容层，供 LLMRouter.run_via_loop 等旧路径使用

M3 Cleanup 后此文件将被删除。新代码使用 agent/loop.py 中的新 AgentLoop。
"""
...
class OldAgentLoop:
    """旧版 Agent Loop — 仅供 LLMRouter.run_via_loop 兼容"""
